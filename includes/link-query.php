	...
	function __construct(){
		...
		$this->native_filters = array(
			'all' => array(
				...
				'name' => __('Alle', 'psource-link-checker'),
				'heading' => __('Erkannte Links', 'psource-link-checker'),
				'heading_zero' => __('(Noch) keine Links gefunden', 'psource-link-checker'),
				'native' => true,
			),
			...
			'broken' => array(
				...
				'name' => __('Defekt', 'psource-link-checker'),
				'heading' => __('Defekte Links', 'psource-link-checker'),
				'heading_zero' => __('Keine defekten Links gefunden', 'psource-link-checker'),
				'native' => true,
			),
			'warnings' => array(
				'params' => array(
				...
				'name' => _x('Warnungen', 'filter name', 'psource-link-checker'),
				'heading' => __('Warnungen', 'filter heading', 'psource-link-checker'),
				'heading_zero' => __('Keine Warnungen gefunden', 'psource-link-checker'),
				'native' => true,
			),
			'redirects' => array(
				'params' => array(
				...
				'name' => __('Weiterleitungen', 'psource-link-checker'),
				'heading' => __('Umgeleitete Links', 'psource-link-checker'),
				'heading_zero' => __('Keine Weiterleitungen gefunden', 'psource-link-checker'),
				'native' => true,
			),
			...
			'dismissed' => array(
				...
				'name' => __('Abgelehnt', 'psource-link-checker'),
				'heading' => __('Abgelehnte Links', 'psource-link-checker'),
				'heading_zero' => __('Keine abgelehnten Links gefunden', 'psource-link-checker'),
				'native' => true,
			),
		);
		...
		$this->search_filter = array(
			'name' => __('Suche', 'psource-link-checker'),
			'heading' => __('Suchergebnisse', 'psource-link-checker'),
			'heading_zero' => __('Keine Links für Deine Anfrage gefunden', 'psource-link-checker'),
			'params' => array(),
			'use_url_params' => true,
			'hidden' => true,
		);
