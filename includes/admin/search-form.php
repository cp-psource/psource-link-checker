...
<div class="search-box">
	...
	<form name="save-search-query" id="custom-filter-form" action="<?php echo admin_url("tools.php?page=view-broken-links");  ?>" method="post" class="blc-inline-form">
		...
		<input type="button" value="<?php esc_attr_e( 'Speichere diese Suche als Filter', 'psource-link-checker' ); ?>" id="blc-create-filter" class="button" />
	</form>				 				
	<?php
	...
	<form name="save-search-query" id="custom-filter-form" action="<?php echo admin_url("tools.php?page=view-broken-links");  ?>" method="post" class="blc-inline-form">
		...
		<input type="submit" value="<?php esc_attr_e( 'Lösche diesen Filter', 'psource-link-checker' ); ?>" id="blc-delete-filter" class="button" />
	</form>
	<?php
			}
	?>
	
	<input type="button" value="<?php esc_attr_e( 'Suche', 'psource-link-checker' ); ?> &raquo;" id="blc-open-search-box" class="button" />
</div>
...
<form class="search-form" action="<?php echo admin_url('tools.php?page=view-broken-links'); ?>" method="get">
	...
	<label for="s_link_text"><?php _e('Linktext', 'psource-link-checker'); ?></label>
	...
	<label for="s_link_url"><?php _e('URL', 'psource-link-checker'); ?></label>
	...
	<label for="s_http_code"><?php _e('HTTP Code', 'psource-link-checker'); ?></label>
	...
	<label for="s_filter"><?php _e('Link Status', 'psource-link-checker'); ?></label>
	...
	<label for="s_link_type"><?php _e('Linktyp', 'psource-link-checker'); ?></label>
	<select name="s_link_type" id="s_link_type">
		<option value=""><?php _e('Alle', 'psource-link-checker'); ?></option>
		<?php
		$moduleManager = blcModuleManager::getInstance();
		
		printf('<optgroup label="%s">', esc_attr(__('Links verwendet in', 'psource-link-checker')));
		...
		printf('<optgroup label="%s">', esc_attr(__('Linktyp', 'psource-link-checker')));
		...
		/*
		$link_types = array(
			__('Any', 'psource-link-checker') => '',
			__('Normal link', 'psource-link-checker') => 'link',
			__('Image', 'psource-link-checker') => 'image',
			__('Custom field', 'psource-link-checker') => 'custom_field',
			__('Bookmark', 'psource-link-checker') => 'blogroll',
			__('Comment', 'psource-link-checker') => 'comment',
		);
		*/
		?>
	</select>
	...
	<div id="blc-search-button-row">
		<input type="submit" value="<?php esc_attr_e( 'Links suchen', 'psource-link-checker' ); ?>" id="blc-search-button" name="search_button" class="button-primary" />
		<input type="button" value="<?php esc_attr_e( 'Abbrechen', 'psource-link-checker' ); ?>" id="blc-cancel-search" class="button" />
	</div>
