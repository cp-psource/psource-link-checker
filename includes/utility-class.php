...
if ( ! class_exists( 'blcUtility' ) ) {
	...
	*/
		static function fuzzy_delta( $delta, $template = 'default' ) {
			...
			$templates = array(
				'seconds' => array(
					'default' => _n_noop('%d Sekunde', '%d Sekunden'),
					'ago' => _n_noop('%d Sekunde', 'vor %d Sekunden'),
				),
				'minutes' => array(
					'default' => _n_noop('%d Minute', '%d Minuten'),
					'ago' => _n_noop('vor %d Minute', 'vor %d Minuten'),
				),
				'hours' => array(
					'default' => _n_noop('%d Stunde', '%d Stunden'),
					'ago' => _n_noop('vor %d Stunde', 'vor %d Stunden'),
				),
				'days' => array(
					'default' => _n_noop('%d Tag', '%d Tage'),
					'ago' => _n_noop('vor %d Tag', 'vor %d Tagen'),
				),
				'months' => array(
					'default' => _n_noop('%d Monat', '%d Monate'),
					'ago' => _n_noop('vor %d Monat', 'vor %d Monaten'),
				),
			);
